...
describe('Event component', () => {
  ...
  test('displays event start time and location', () => {
    ...
    expect(screen.getByTestId('event-start')).toHaveTextContent(`Starts at: ${expectedStart}`);
  
    // Check location is displayed
    expect(screen.getByTestId('event-location')).toHaveTextContent(`Location: ${sampleEvent.location}`);
  });
});
